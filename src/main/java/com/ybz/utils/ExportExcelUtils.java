...
public class ExportExcelUtils {
     ...
     */
    public void exportExcelFile(String sheetName, String titleName, String[] headers, Collection<?> dataSet, String resultUrl, HttpServletResponse response, String pattern) {
     ...
     * 参数: pattern[时间类型数据的格式]
     */
    public void exportExcelResponse(String sheetName, String titleName, String[] headers, Collection<?> dataSet, HttpServletResponse response, String pattern) {

        doExportExcel(sheetName, titleName, headers, dataSet, null, response, pattern);
     ...
     * 功能:真正实现导出
     */
    private void doExportExcel(String sheetName, String titleName, String[] headers, Collection<?> dataSet, String resultUrl, HttpServletResponse response, String pattern) {
